...
pub fn tr_ability(name: &str, lang: Language) -> &str {
    match lang {
        Language::PtBr => match name {
            // Talentos / Talents
            "Alertness" | "Prontidão" => "Prontidão",
            "Art" | "Arte" => "Arte",
            "Athletics" | "Esportes" => "Esportes",
            "Brawl" | "Briga" => "Briga",
            "Dodge" | "Esquiva" => "Esquiva",
            "Awareness" | "Consciência" => "Consciência",
            "Empathy" | "Empatia" => "Empatia",
            "Expression" | "Expressão" => "Expressão",
            "Intimidação" | "Intimidation" => "Intimidação",
            "Leadership" | "Liderança" => "Liderança",
            "Streetwise" | "Manha" => "Manha",
            "Subterfuge" | "Lábia" => "Lábia",

            // Perícias / Skills
            "Crafts" | "Ofícios" => "Ofícios",
            "Drive" | "Condução" => "Condução",
            "Etiquette" | "Etiqueta" => "Etiqueta",
            "Firearms" | "Armas de Fogo" => "Armas de Fogo",
            "Martial Arts" | "Artes Marciais" => "Artes Marciais",
            "Meditation" | "Meditação" => "Meditação",
            "Melee" | "Armas Brancas" => "Armas Brancas",
            "Performance" => "Performance",
            "Research" | "Pesquisa" => "Pesquisa",
            "Stealth" | "Furtividade" => "Furtividade",
            "Survival" | "Sobrevivência" => "Sobrevivência",
            "Technology" | "Tecnologia" => "Tecnologia",

            // Conhecimentos / Knowledges
            "Academics" | "Acadêmicos" => "Acadêmicos",
            "Computer" | "Computador" => "Computador",
            "Cosmology" | "Cosmologia" => "Cosmologia",
            "Enigmas" => "Enigmas",
            "Esoterica" | "Esotérica" => "Esotérica",
            "Investigation" | "Investigação" => "Investigação",
            "Law" | "Direito" => "Direito",
            "Medicine" | "Medicina" => "Medicina",
            "Occult" | "Ocultismo" => "Ocultismo",
            "Politics" | "Política" => "Política",
            "Science" | "Ciência" => "Ciência",

            _ => name,
        },
        Language::EnUs => match name {
            // Talentos / Talents
            "Alertness" | "Prontidão" => "Alertness",
            "Art" | "Arte" => "Art",
            "Athletics" | "Esportes" => "Athletics",
            "Brawl" | "Briga" => "Brawl",
            "Dodge" | "Esquiva" => "Dodge",
            "Awareness" | "Consciência" => "Awareness",
            "Empathy" | "Empatia" => "Empathy",
            "Expression" | "Expressão" => "Expression",
            "Intimidação" | "Intimidation" => "Intimidation",
            "Leadership" | "Liderança" => "Leadership",
            "Streetwise" | "Manha" => "Streetwise",
            "Subterfuge" | "Lábia" => "Subterfuge",

            // Perícias / Skills
            "Crafts" | "Ofícios" => "Crafts",
            "Drive" | "Condução" => "Drive",
            "Etiquette" | "Etiqueta" => "Etiquette",
            "Firearms" | "Armas de Fogo" => "Firearms",
            "Martial Arts" | "Artes Marciais" => "Martial Arts",
            "Meditation" | "Meditação" => "Meditation",
            "Melee" | "Armas Brancas" => "Melee",
            "Performance" => "Performance",
            "Research" | "Pesquisa" => "Research",
            "Stealth" | "Furtividade" => "Stealth",
            "Survival" | "Sobrevivência" => "Survival",
            "Technology" | "Tecnologia" => "Technology",

            // Conhecimentos / Knowledges
            "Academics" | "Acadêmicos" => "Academics",
            "Computer" | "Computador" => "Computer",
            "Cosmology" | "Cosmologia" => "Cosmology",
            "Enigmas" => "Enigmas",
            "Esoterica" | "Esotérica" => "Esoterica",
            "Investigation" | "Investigação" => "Investigation",
            "Law" | "Direito" => "Law",
            "Medicine" | "Medicina" => "Medicine",
            "Occult" | "Ocultismo" => "Occult",
...
pub fn tr_header_label(key: &str, lang: Language) -> &str {
    match lang {
        Language::PtBr => match key {
            ...
            "Cronica" | "Crônica" | "Chronicle" => "Crônica",
            "Natureza" | "Nature" => "Natureza",
            "Essencia" | "Essência" | "Essence" => "Essência",
            "Comportamento" | "Demeanor" => "Comportamento",
            "Tradicao" | "Tradição" | "Tradition" => "Tradição",
            "Conceito" | "Concept" => "Conceito",
            "Cabala" | "Cabal" => "Cabala",
            "Tipo" | "Type" => "Tipo",
            _ => key,
        },
        Language::EnUs => match key {
            ...
            "Cronica" | "Crônica" | "Chronicle" => "Chronicle",
            "Natureza" | "Nature" => "Nature",
            "Essencia" | "Essência" | "Essence" => "Essence",
            "Comportamento" | "Demeanor" => "Demeanor",
            "Tradicao" | "Tradição" | "Tradition" => "Tradition",
            "Conceito" | "Concept" => "Concept",
            "Cabala" | "Cabal" => "Cabal",
            "Tipo" | "Type" => "Type",
            _ => key,
        },
...
pub fn tr(key: &str, lang: Language) -> &str {
    match lang {
        Language::PtBr => match key {
            ...
            // Gods & Monsters
            "gods_monsters_title" => "DEUSES & MONSTROS",
            "charms" => "Encantos",
            "charm_ph" => "Encanto...",
            "add_charm" => "Adicionar Encanto",
            "gifts" => "Dons",
            "gift_ph" => "Dom...",
            "add_gift" => "Adicionar Dom",
            "gnosis" => "Gnose",
            "special_advantages" => "Vantagens Especiais",
            "special_adv_ph" => "Vantagem Especial...",
            "add_special_adv" => "Adicionar Vantagem Especial",
            "clear_essence" => "Limpar Essência",
            "spent" => "Gasto",
            "add_background" => "Adicionar Antecedente",
            "remove_line" => "Remover linha",
            "history" => "Histórico",
            "gods_history_ph" => "História de origem, pacto místico com o Mago ou natureza sobrenatural...",
            "description" => "Descrição",
            "gods_desc_ph" => "Aparência física, forma espiritual, tamanho, sons e traços peculiares...",
            "special_rules" => "Regras Especiais",
            "gods_rules_ph" => "Regras de materialização, restrições alimentares, fraquezas ou comandos mágicos...",
            "combat" => "Combate",
            "weapon_attack" => "Arma / Ataque",
            "weapon_ph" => "Arma...",
            "merit" => "Qualidade",
            "merit_ph" => "Qualidade...",
            "flaw" => "Defeito",
            ...
            "cost" => "Custo",
            "bonus" => "Bônus",
            "gm_tab_1_title" => "Atributos & Poderes",
            "gm_tab_2_title" => "Características & Combate",
            "gm_tab_1_page" => "Página 1",
            "gm_tab_2_page" => "Página 2",
            "gm_tab_1_tooltip" => "Página 1: Atributos, Habilidades e Vantagens",
            "gm_tab_2_tooltip" => "Página 2: Outros Traços, Qualidades & Defeitos, Histórico, Regras e Combate",
            "add_extra_bruised" => "Adicionar nível extra de Escoriado (Criatura / Bygone)",
            "remove_extra_bruised" => "Remover nível extra de Escoriado",
            "xp_ph" => "Registro de XP / Pontos de Criação...",
            _ => key,
        },
        Language::EnUs => match key {
            "mode" => "Mode:",
            ...
            // Gods & Monsters
            "gods_monsters_title" => "GODS & MONSTERS",
            "charms" => "Charms",
            "charm_ph" => "Charm...",
            "add_charm" => "Add Charm",
            "gifts" => "Gifts",
            ...
            "add_gift" => "Add Gift",
            "gnosis" => "Gnosis",
            "special_advantages" => "Special Advantages",
            "special_adv_ph" => "Special Advantage...",
            "add_special_adv" => "Add Special Advantage",
            "clear_essence" => "Clear Essence",
            "spent" => "Spent",
            "add_background" => "Add Background",
            "remove_line" => "Remove line",
            "history" => "History",
            "gods_history_ph" => "Origin story, mystical pact with the Mage, or supernatural nature...",
            "description" => "Description",
            "gods_desc_ph" => "Physical appearance, spirit form, size, sounds and peculiar traits...",
            "special_rules" => "Special Rules",
            "gods_rules_ph" => "Materialization rules, feeding restrictions, banes, weaknesses or magical commands...",
            "combat" => "Combat",
            ...
            "cost" => "Cost",
            "bonus" => "Bonus",
            "gm_tab_1_title" => "Attributes & Powers",
            "gm_tab_2_title" => "Traits, Rules & Combat",
            "gm_tab_1_page" => "Page 1",
            "gm_tab_2_page" => "Page 2",
            "gm_tab_1_tooltip" => "Page 1: Attributes, Abilities & Advantages",
            "gm_tab_2_tooltip" => "Page 2: Other Traits, Merits & Flaws, History, Rules & Combat",
            "add_extra_bruised" => "Add extra Bruised health level (Creature / Bygone)",
            "remove_extra_bruised" => "Remove extra Bruised health level",
            "xp_ph" => "XP Log / Creation Points...",
            _ => key,
        },
    }
}

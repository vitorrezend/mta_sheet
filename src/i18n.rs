...
/// Translates standard spheres and technocratic variants
pub fn tr_sphere(name: &str, lang: Language) -> &str {
    match lang {
        Language::PtBr => match name {
            "Data" => "Dados",
            "Primal Utility" => "Utilidade Primordial",
            "Dimensional Science" => "Ciência Dimensional",
            _ => name,
        },
        Language::EnUs => match name {
            ...
            "Tempo" => "Time",
            "Dados" => "Data",
            "Utilidade Primordial" => "Primal Utility",
            "Ciência Dimensional" => "Dimensional Science",
            _ => name,
        },
    }
}
...
pub fn tr_auth_error(msg: &str, lang: Language) -> String {
    ...
    match lang {
        Language::PtBr => match clean {
            ...
            "A senha deve ter no mínimo 8 caracteres." | "Password must be at least 8 characters." => "A senha deve ter no mínimo 8 caracteres.".to_string(),
            "A senha não pode exceder 128 caracteres." | "Password cannot exceed 128 characters." => "A senha não pode exceder 128 caracteres.".to_string(),
            "A senha deve conter pelo menos uma letra e um número." | "Password must contain at least one letter and one number." => "A senha deve conter pelo menos uma letra e um número.".to_string(),
            "Muitas tentativas de cadastro. Aguarde 1 minuto antes de tentar novamente." | "Too many registration attempts. Please wait 1 minute before trying again." => "Muitas tentativas de cadastro. Aguarde 1 minuto antes de tentar novamente.".to_string(),
            "Muitas tentativas de login. Aguarde 1 minuto antes de tentar novamente." | "Too many login attempts. Please wait 1 minute before trying again." => "Muitas tentativas de login. Aguarde 1 minuto antes de tentar novamente.".to_string(),
        ...
        Language::EnUs => match clean {
            ...
            "A senha deve ter no mínimo 8 caracteres." | "Password must be at least 8 characters." => "Password must be at least 8 characters.".to_string(),
            "A senha não pode exceder 128 caracteres." | "Password cannot exceed 128 characters." => "Password cannot exceed 128 characters.".to_string(),
            "A senha deve conter pelo menos uma letra e um número." | "Password must contain at least one letter and one number." => "Password must contain at least one letter and one number.".to_string(),
            "Muitas tentativas de cadastro. Aguarde 1 minuto antes de tentar novamente." | "Too many registration attempts. Please wait 1 minute before trying again." => "Too many registration attempts. Please wait 1 minute before trying again.".to_string(),
            "Muitas tentativas de login. Aguarde 1 minuto antes de tentar novamente." | "Too many login attempts. Please wait 1 minute before trying again." => "Too many login attempts. Please wait 1 minute before trying again.".to_string(),
...
pub fn tr(key: &str, lang: Language) -> &str {
    match lang {
        Language::PtBr => match key {
            ...
            "about_collab" => "✨ Sobre & Colabore",
            "about_subtitle" => "Uma plataforma livre, independente e de código aberto criada por fãs para apoiar a comunidade de jogadores e narradores de Mago: A Ascensão (M20) com auxilio da ficha de Deuses & Monstros.",
            "logout" => "Sair",
            "dynamic" => "Dinâmica",
            "static" => "Estática",
            "entropic" => "Entrópica",
            ...
            "weapon_compendium_title" => "Compêndio M20: Armas Brancas",
            "weapon_compendium_sub" => "M20, pp. 450-451 • Catálogo Canônico de Combate Corpo a Corpo",
            "weapon_notes_header" => "NOTAS DE REGRAS",
            "weapon_legend_title" => "Legenda de Parâmetros & Notas (#1 a #10)",
            "weapon_equip_action" => "Equipar na Ficha",
            ...
            // Home Page
            "home_hero_badge" => "SISTEMA CANÔNICO WORLD OF DARKNESS • M20",
            "home_hero_title" => "Desperte a Mágika da sua Cabala",
            "home_hero_subtitle" => "O mais completo gerenciador e automatizador de fichas para Mago: A Ascensão (20th Anniversary Edition) e Gods & Monsters. Crie personagens canônicos, audite Bônus e XP, catalogue Rotes e gerencie salas em tempo real.",
            "home_hero_cta_start" => "⚡ Começar Agora / Criar Conta",
            "home_hero_cta_rooms" => "🏰 Salas de Jogo & Crônicas",
            "home_pillar_m20" => "🌟 M20 20th Anniversary",
            "home_pillar_gm" => "🐾 Gods & Monsters",
            "home_pillar_do" => "🥋 Artes Marciais & Dô",
            "home_pillar_rooms" => "🏰 Salas de Jogo & Crônicas",
            "home_pillar_dossier" => "📂 Dossiê (14 Perguntas)",
            "home_showcase_title" => "Tudo o que sua Crônica precisa em um só lugar",
            "home_showcase_sub" => "Projetado com respeito absoluto às regras oficiais de M20 e com tecnologia de alta performance em Rust Full-Stack.",
            "home_feat1_title" => "Ficha Completa de 6 Páginas",
            "home_feat1_desc" => "Atributos, 30+ Habilidades, 9 Esferas de Afinidade, Arete, trilha dinâmica de Quintessência e Paradoxo, Vitalidade com ciclo [/], [X], [*], Qualidades/Defeitos e Grimório de Rotinas Mágikas.",
            "home_feat2_title" => "Automação de Regras & Extrato",
            "home_feat2_desc" => "Controle inteligente de Modo Criação, Modo Bônus (15 pts livres calculados automaticamente) e Modo XP com modal de auditoria analítica de legalidade perante o livro de regras.",
            "home_feat3_title" => "Compêndio de Combate, Armas & Dô",
            "home_feat3_desc" => "Catálogo canônico de armas brancas e de fogo, manobras de combate e a arte marcial dos Irmãos de Akasha com a regra do Caminho Pacífico, 8 Membros de Maestria e 9 Técnicas Especiais.",
            "home_feat4_title" => "Central da Crônica & Mesas",
            "home_feat4_desc" => "Salas protegidas por código MTA, monitor de Vitalidade da Cabala em tempo real, Capela compartilhada de Quintessência, diário de sessão e controle de fichas de NPCs.",
            "home_stats_badge" => "● Estatísticas em Tempo Real",
            "home_stats_title" => "O Multiverso M20 em Números",
            "home_stats_sub" => "Métricas ativas de personagens, mestres e crônicas despertas na plataforma.",
            "home_stats_users" => "Usuários Cadastrados",
            "home_stats_users_desc" => "Magos & Narradores",
            "home_stats_rooms" => "Salas de Crônica",
            "home_stats_rooms_desc" => "Mesas & Crônicas Ativas",
            "home_stats_m20" => "Fichas M20",
            "home_stats_m20_desc" => "Mago: A Ascensão",
            "home_stats_gm" => "Gods & Monsters",
            "home_stats_gm_desc" => "Criaturas & Familiares",
            "home_stats_pub" => "públicas",
            "home_stats_priv" => "privadas",
            ...
            "home_tab_showcase" => "✨ Apresentação & Recursos",
            ...
            "card_move_tooltip" => "Mover para pasta...",
            "folder_all" => "Todas",
            "folder_unorganized" => "Sem Pasta",
            "folder_new" => "Nova Pasta",
            "folder_modal_create_title" => "Criar Nova Pasta",
            "folder_modal_edit_title" => "Editar Pasta",
            "folder_modal_delete_title" => "Excluir Pasta",
            "folder_modal_delete_desc" => "As fichas nesta pasta NÃO serão excluídas; elas voltarão para a categoria Sem Pasta.",
            "folder_modal_move_title" => "Mover Ficha para Pasta",
            "folder_name_label" => "Nome da Pasta",
            "folder_name_ph" => "ex: Cabala de Boston, NPCs...",
            "folder_icon_label" => "Ícone da Pasta",
            "folder_save" => "Salvar Alterações",
            "folder_create" => "Criar Pasta",
            "folder_empty_in_folder" => "Nenhuma ficha encontrada nesta pasta.",
            "drive_my_sheets" => "Minhas Fichas",
            "drive_all_sheets" => "Todas as Fichas",
            "drive_root_sheets" => "Fichas Soltas",
            "drive_folders_title" => "Pastas",
            "drive_sheets_title" => "Fichas",
            "drive_btn_new_folder" => "+ Nova Pasta",
            "drive_btn_back" => "← Voltar",
            "drive_folder_empty" => "Esta pasta está vazia. Crie uma nova ficha acima ou mova fichas para cá.",
            "drive_creating_in_folder" => "Criando na pasta:",
            "drive_item_count_single" => "ficha",
            "drive_item_count_plural" => "fichas",
            "drive_move_to_root" => "Minhas Fichas (Raiz / Sem Pasta)",
            "drive_subfolders_title" => "Subpastas",
            "drive_btn_new_subfolder" => "+ Nova Subpasta",
            "drive_share_folder" => "Compartilhar",
            "drive_share_modal_title" => "Permissões de Acesso (ACL)",
            "drive_share_with_user" => "Jogador",
            "drive_share_with_room" => "Sala de Crônica",
            "drive_share_permission_read" => "Leitura (Visualizar)",
            "drive_share_permission_write" => "Edição (Mover/Adicionar Fichas)",
            "drive_share_permission_admin" => "Administrador (Controle Total)",
            "drive_share_owner" => "Proprietário",
            "drive_share_empty" => "Nenhum compartilhamento ativo para esta pasta.",
            "drive_share_add_btn" => "Conceder Acesso",
            "drive_share_close" => "Fechar",
            "drive_share_revoke_btn" => "Revogar",
            "drive_share_inherited_note" => "Subpastas e fichas herdam automaticamente as permissões desta pasta.",
        ...
        Language::EnUs => match key {
            ...
            "about_collab" => "✨ About & Contribute",
            "about_subtitle" => "A free, independent, open-source platform created by fans to support the Mage: The Ascension (M20) player and storyteller community, with the aid of the Gods & Monsters sheet companion.",
            "logout" => "Logout",
            "dynamic" => "Dynamic",
            "static" => "Static",
            "entropic" => "Entropic",
            ...
            "weapon_compendium_title" => "M20 Compendium: Melee Weapons",
            "weapon_compendium_sub" => "M20, pp. 450-451 • Canonical Melee Combat Weapons",
            "weapon_notes_header" => "RULE NOTES",
            "weapon_legend_title" => "Parameters & Notes Legend (#1 to #10)",
            "weapon_equip_action" => "Equip to Sheet",
            ...
            // Home Page
            "home_hero_badge" => "CANONICAL WORLD OF DARKNESS SYSTEM • M20",
            "home_hero_title" => "Awaken the Magick of your Cabal",
            "home_hero_subtitle" => "The ultimate interactive character manager and rule automator for Mage: The Ascension (20th Anniversary Edition) and Gods & Monsters. Create canonical characters, audit Freebie points & XP, catalog Rotes, and run live rooms in real time.",
            "home_hero_cta_start" => "⚡ Get Started / Register",
            "home_hero_cta_rooms" => "🏰 Game Rooms & Chronicles",
            "home_pillar_m20" => "🌟 M20 20th Anniversary",
            "home_pillar_gm" => "🐾 Gods & Monsters",
            "home_pillar_do" => "🥋 Martial Arts & Dô",
            "home_pillar_rooms" => "🏰 Live Rooms & Chronicles",
            "home_pillar_dossier" => "📂 Dossier (14 Questions)",
            "home_showcase_title" => "Everything your Chronicle needs in one place",
            "home_showcase_sub" => "Engineered with absolute fidelity to official M20 rules and high-performance Rust Full-Stack technology.",
            "home_feat1_title" => "Complete 6-Page Character Sheet",
            "home_feat1_desc" => "Attributes, 30+ Abilities, 9 Affinity Spheres, Arete, dynamic 20-box Quintessence and Paradox track, Health cycle ([/], [X], [*]), Merits/Flaws, and Rote Grimoire.",
            "home_feat2_title" => "Rule Automation & Cost Audit",
            "home_feat2_desc" => "Smart tracking across Creation Mode, Freebie Mode (15 points auto-calculated), and XP Mode with analytical ledger verifying rulebook legality in real time.",
            "home_feat3_title" => "Combat Compendium, Weapons & Dô",
            "home_feat3_desc" => "Canonical arsenal of melee and ranged weapons, combat maneuvers, and the Akashayana martial art of Dô featuring The Peaceful Way, 8 Limbs of Mastery, and 9 Special Techniques.",
            "home_feat4_title" => "Chronicle Central & Game Rooms",
            "home_feat4_desc" => "Private game rooms with MTA code, live Cabal Health monitor, shared Chantry Quintessence pool, session chronicle diary, and hidden NPC sheets.",
            "home_stats_badge" => "● Real-Time Community Stats",
            "home_stats_title" => "The M20 Multiverse in Numbers",
            "home_stats_sub" => "Live metrics of characters, storytellers, and chronicles active on the platform.",
            "home_stats_users" => "Registered Users",
            "home_stats_users_desc" => "Mages & Storytellers",
            "home_stats_rooms" => "Chronicle Rooms",
            "home_stats_rooms_desc" => "Active Cabals & Tables",
            "home_stats_m20" => "M20 Character Sheets",
            "home_stats_m20_desc" => "Mage: The Ascension",
            "home_stats_gm" => "Gods & Monsters",
            "home_stats_gm_desc" => "Entities & Familiars",
            "home_stats_pub" => "public",
            "home_stats_priv" => "private",
            "home_header_title" => "MTA Character Manager",
            ...
            "home_tab_showcase" => "✨ Showcase & Features",
            ...
            "card_move_tooltip" => "Move to folder...",
            "folder_all" => "All",
            "folder_unorganized" => "Unorganized",
            "folder_new" => "New Folder",
            "folder_modal_create_title" => "Create New Folder",
            "folder_modal_edit_title" => "Edit Folder",
            "folder_modal_delete_title" => "Delete Folder",
            "folder_modal_delete_desc" => "Sheets inside this folder will NOT be deleted; they will be moved to the Unorganized category.",
            "folder_modal_move_title" => "Move Sheet to Folder",
            "folder_name_label" => "Folder Name",
            "folder_name_ph" => "e.g.: Boston Cabal, NPCs...",
            "folder_icon_label" => "Folder Icon",
            "folder_save" => "Save Changes",
            "folder_create" => "Create Folder",
            "folder_empty_in_folder" => "No sheets found in this folder.",
            "drive_my_sheets" => "My Sheets",
            "drive_all_sheets" => "All Sheets",
            "drive_root_sheets" => "Loose Sheets",
            "drive_folders_title" => "Folders",
            "drive_sheets_title" => "Sheets",
            "drive_btn_new_folder" => "+ New Folder",
            "drive_btn_back" => "← Back",
            "drive_folder_empty" => "This folder is empty. Create a new sheet above or move sheets here.",
            "drive_creating_in_folder" => "Creating in folder:",
            "drive_item_count_single" => "sheet",
            "drive_item_count_plural" => "sheets",
            "drive_move_to_root" => "My Sheets (Root / Unorganized)",
            "drive_subfolders_title" => "Subfolders",
            "drive_btn_new_subfolder" => "+ New Subfolder",
            "drive_share_folder" => "Share",
            "drive_share_modal_title" => "Access Control (ACL)",
            "drive_share_with_user" => "Player",
            "drive_share_with_room" => "Chronicle Room",
            "drive_share_permission_read" => "Read (View only)",
            "drive_share_permission_write" => "Edit (Move/Add Sheets)",
            "drive_share_permission_admin" => "Admin (Full Control)",
            "drive_share_owner" => "Owner",
            "drive_share_empty" => "No active shares for this folder.",
            "drive_share_add_btn" => "Grant Access",
            "drive_share_close" => "Close",
            "drive_share_revoke_btn" => "Revoke",
            "drive_share_inherited_note" => "Subfolders and sheets automatically inherit permissions from this folder.",

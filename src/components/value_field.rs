...
// Tests removed as they require wasm-bindgen-test which is not available in the current environment
// for standard cargo test, and they were failing to compile.
